...
Local contrast normalization: The idea ``This module... [enforces] a sort of
local competition between features in a feature map, and between
features at the same stage in different feature maps.''
